      ...
      <div className='student__info-container'>
        <div className='student__info-text-container'>
          ...
          <p className='student__info-description'>
            ...
            инеженер по специальности “Электроснабжение”, магистр техники и
            технологии. Сейчас руководитель бригады по электромонтажу,
            параллельно занимаюсь поисками работы в вебе. Год назад начал
            изучение веб-разработки. Было трудно проходить курс и работать
            одновременно, но уже финишная прямая, данная работа - тому
            подтверждение. Программирование - новая веха в моей жизни, через веб
            хочу положительно влиять на умы людей.
          </p>
          <a
