      ...
      <div className='student__info-container'>
        <div className='student__info-text-container'>
          ...
          <p className='student__info-description'>
            ...
            распределительных щитов. Чуть больше года назад начал изучение
            веб-разработки. Было трудно проходить курс и работать одновременно,
            но я это сделал, данный проект тому подтверждение. Программирование
            - новая веха в моей жизни, через веб хочу положительно влиять на умы
            людей.
          </p>
          <a
